...
from schemas.transaction import TransactionPayload, TransactionType
...
class AccountService:
    ...
    @staticmethod
    def record_transaction(account_id:str, amount: Decimal, transaction_type: TransactionType):
        transaction = {
    ...
    def deposit_fund(account_id: str, amount: Decimal):
        ...
        transaction = account_service.record_transaction(
